      ...
      <nav className="nav" id="nav">
        <div className="nav-inner">
          ...
          <ul className="nav-list" id="navList">
            ...
            <li><a href="https://emergency-locksmith.vercel.app/" target="_blank" rel="noopener noreferrer" className="nav-link">Locksmith</a></li>
          ...
          <div className="section-inner">
            ...
            <div className="category-nav">
              ...
              <div className="category-nav-list">
                ...
                <a href="https://emergency-locksmith.vercel.app/" target="_blank" rel="noopener noreferrer" className="category-nav-link">🔐 Locksmith</a>
          ...
          <div className="footer-grid">
            ...
            <div className="footer-column">
              ...
              <div className="footer-links">
                ...
                <a href="https://emergency-locksmith.vercel.app/" target="_blank" rel="noopener noreferrer" className="footer-link">Locksmith</a>
              </div>
            </div>
            <div className="footer-column">
